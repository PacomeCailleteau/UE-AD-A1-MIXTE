...
class ShowtimeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetShowtimeByDate = channel.unary_unary(
                ...
                response_deserializer=to__import__pb2.ShowtimeData.FromString,
...
def add_ShowtimeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetShowtimeByDate': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=to__import__pb2.ShowtimeData.SerializeToString,
            ),
...
class Showtime(object):
    ...
    def GetShowtimeByDate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            to__import__pb2.ShowtimeData.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
